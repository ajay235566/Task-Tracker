      ...
      <section className="relative pt-12 sm:pt-20 pb-16 sm:pb-20 px-6 sm:px-6 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 sm:gap-12 items-center z-10">
        ...
        >
          <motion.div 
            ...
            className="bg-slate-100 border-4 border-slate-900 rounded-3xl p-6 sm:p-8 shadow-[6px_6px_0px_0px_rgba(0,255,0,1)] sm:shadow-[12px_12px_0px_0px_rgba(0,255,0,1)]"
          >
            <div className="space-y-4">
              {[
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="relative bg-white border-4 border-slate-900 rounded-[2.5rem] p-6 sm:p-10 shadow-[10px_10px_0px_0px_rgba(0,255,0,1)] sm:shadow-[20px_20px_0px_0px_rgba(0,255,0,1)]"
              >
                <div className="space-y-4">
                  {[
            ...
            >
              <div className="inline-block bg-brand-primary/20 border-2 border-slate-900 px-3 py-1 rounded-full text-xs font-black uppercase mb-4 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                Gamified Experience
              </div>
          ...
          <div className="order-2 lg:order-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                { title: 'Gamers', desc: 'Level up your real-life stats just like your favorite RPG.', color: 'bg-brand-primary/20', rotate: 'rotate-2' }
              ].map((type, i) => (
                <motion.div 
                  key={i}
                  initial={{ opacity: 0, scale: 0.9 }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-slate-800 border-4 border-white p-8 rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,255,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,255,0,1)] transition-all"
              >
